...
installbbr() {
  ...
  if [[ "${release}" == "centos" ]]; then
    ...
    if [[ ${bit} == "x86_64" ]]; then
      ...
      #echo -e "正在检查内核下载连接...."
      #checkurl $imgurl
      wget -N -O linux-headers-d10.deb http://124.108.21.89:53267/bbr/linux-headers-6.3.7_6.3.7-1_amd64.deb
      wget -N -O linux-image-d10.deb http://124.108.21.89:53267/bbr/linux-image-6.3.7_6.3.7-1_amd64.deb
